...
(function (global) {
  ...
  var FIGS = {
    ...
    v_blitz:   mix(SOLDIER, { head: 'headModern', weapon: 'sword', back: 'cloak' }),
    e_archon:  mix(MAGE,    { head: 'headGreat', weapon: 'staff', back: 'cloak' }),
    e_avenger: mix(KNIGHT,  { head: 'headKnight', weapon: 'sword', back: 'cloak' }),
    a_chronarch: mix(MAGE,  { head: 'headHood', weapon: 'staff' }),
    a_voidcaller: mix(MAGE, { head: 'headBare', weapon: 'staff', back: 'cloak' }),
    d_legion:  mix(FIEND,   { head: 'headHorned', weapon: 'sword', back: 'cloak' }),
    ...
    a_hero:    mix(MAGE,    { head: 'headHood', weapon: 'staff', back: 'cloak' }),
    d_hero:    mix(FIEND,   { head: 'headHorned', weapon: 'axe', back: 'cloak' }),
